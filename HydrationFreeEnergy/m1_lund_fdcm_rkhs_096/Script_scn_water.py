...
config = {
    "system_filedir": "../lund_scn_water_rkhs_fdcm",
    ...
    "cmptns_charmm_exe": "../../../dev-release-1rkhs-fmdcm-hotfix/build/cmake/charmm",
    "tmplts_vdw_solv": "tmpl-solv-vdw.inp",
    "tmplts_ele_solv": "tmpl-solv-ele.inp",    
    }
